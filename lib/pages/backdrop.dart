...
class _BackdropState extends State<Backdrop> with TickerProviderStateMixin {
  ...
  late final FocusNode _settingsPageFocusNode;
  late final ValueNotifier<bool> _isSettingsOpenNotifier;
  late final Widget _settingsPage;
  ...
  Widget _buildStack(BuildContext context, BoxConstraints constraints) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: AppSettings.of(context).resolvedSystemUiOverlayStyle(),
      child: Stack(
        children: [
          if (!isDesktop) ...[
            ...
            child: InkWell(
              onTap: () {
                ...
                SemanticsService.announce(
                  ...
                  AppSettings.of(context).resolvedTextDirection() ??
                      TextDirection.ltr,
                );
              },
              // child: Padding(
